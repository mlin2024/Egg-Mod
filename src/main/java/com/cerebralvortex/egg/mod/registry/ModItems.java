...
public class ModItems {
	public static Item YOLK_BUCKET;
	...
	public static void registerItems() {
		...
		// Yolk
		YOLK_BUCKET = Registry.register(Registry.ITEM, new Identifier(EggMod.MOD_ID, "yolk_bucket"), new BucketItem(ModBlocks.STILL_YOLK, new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1).group(EggMod.EGG_ITEMS)));
	}
}